    ...
    <div class="top-area">
      ...
      <div class="btn-group">
        <el-button
          type="primary"
          icon="el-icon-plus"
          @click="$router.push({path:'/article/add&edit'})"
        >新增文章</el-button>
      </div>
      <!-- 按钮组 -->
      ...
      >
        ...
        <el-table-column label="封面图" width="80">
          <template slot-scope="scope">
            <img v-if="scope.row.pic_url && scope.row.pic_url != ''" :src="scope.row.pic_url" style="margin-right:10px" width="50" height="50" alt />
