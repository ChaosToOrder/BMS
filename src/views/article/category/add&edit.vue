      ...
      <el-row>
        ...
        <el-col :span="8">
          <div class="area">
            ...
            <!-- 文章类型名 -->
            <el-form-item label="文章类型名" prop="type_name">
              <el-input v-model="form.type_name" placeholder="文章类型名"></el-input>
            </el-form-item>

            <!-- 描述 -->
            <el-form-item label="描述" prop="type_desc">
              <el-input type="textarea" :rows="3" v-model="form.type_desc" placeholder="描述"></el-input>
            </el-form-item>
