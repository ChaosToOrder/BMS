<template>
  <div class="list-page">
    ...
    <div class="table-list" v-loading="loading">
      ...
      >
        <!-- ID -->
        <el-table-column prop="type_id" label="ID" width="50"></el-table-column>
        <!-- 类型名 -->
        <el-table-column prop="type_name" label="类型名"></el-table-column>
        <!-- 说明 -->
        <el-table-column prop="type_desc" label="说明"></el-table-column>
        
        <!-- 封面 -->
        <el-table-column label="封面" width="80">
          <template slot-scope="scope" >
            <img
            v-if="scope.row.pic_url && scope.row.pic_url != ''"
