...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            'print', 'preview', 'searchreplace', 'drafts', 'help', 'qxupload'
        ]]
		...
		,whitList: {
            ...
            // qqmusic: ['class', 'style','src','music_name','singer','play_length','albumid','jumpurlkey','audiourl','albumurl','musicid','mid'],
            source: ['src', 'type'],
